...
#
lbl = tk.Label(root, text="Skin Cancer Detection System ", font=('times', 35,' bold '), height=1, width=25,bg="white",fg="black")
        ...
        if Skin_diseases==0:
           ...
           #cursor.execute(sql_fetch_blob_query, (id))
            ...
            for row in r_set:
               ...
               with open(r"D:/User/Desktop/project/SkinCancer/SkinCancer/Report/Report.txt", 'w') as f:
                   for row in r_set1:
                       line = "ID:"+ "\t" + str(row[0])+","+ "\n"+ "Name:"+ "\t"+str(row[1])+ ","+ "\n"+ "Address:"+ "\t" + str(row[2])+"\n"+ " Result:-Benign"#,row[3],row[4],row[5],row[6]
                       f.write(line)
                       print(row[0],row[1],row[2],row[3],row[4],row[5],row[6])
             # with open(r"D:/User/Desktop/project/SkinCancer/SkinCancer/Report.txt", 'w') as f:
                  #for row in record:
           ...
           #cursor.execute(sql_fetch_blob_query, (id))
            ...
            for row in r_set:
             ...
             #file = open(r"E:/SkinCancer/SkinCancer/Report.txt", 'w')
